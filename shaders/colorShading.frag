...
void main()
{
	...
	{
		color = vec4(fragmentColor.r * sin((fragmentPosition.x/fragmentPosition.y) * 6 + time) + 1.8 * 0.5,
					fragmentColor.g * sin((fragmentPosition.x/fragmentPosition.y)* 6 + time) + 1.8 * 0.5,
					fragmentColor.b * sin((fragmentPosition.x/fragmentPosition.y) * 6 + time) + 1.3 * 0.5,
